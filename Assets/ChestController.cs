...
public class ChestController : MonoBehaviour {
    ...
    void OnTriggerEnter2D(Collider2D otherCollider)
    {
            if (otherCollider.gameObject.CompareTag("Arrow"))
            {
                ...
                //enemy hit sound
                    this._chestCollider.isTrigger = true; //so it doesn't check a collision with collision2d - colliding with the player after being hit, let the death animatoin play-out before destroying enemy object
